...
export const desktopHeaderPhrase = ['Your Exam Success,', 'Your Way'];
export const desktopParagraphPhrase = [
  'We believe that preparing for exams should be simple and effective.',
  "That's why we give you the tools to succeed your way.",
];
export const desktopBriefNotePhrase = [
...
// For mobile
export const mobileHeaderPhrase = ['Your Exam', 'Success, Your Way'];
export const mobileParagraphPhrase = [
  'We believe that preparing for exams should be',
  'simple and effective. That’s why we give you',
  'the tools to succeed your way.',
];
...
export const edges = [
  {
    point: 'No limits on practice',
    details:
      'Practice as much as you want with unlimited tests and questions, anytime, anywhere.',
    icon: ic_banknotes,
  },
  {
    point: 'AI-powered search',
    details:
      'Get instant help with our AI-enabled search engine, even during timed tests.',
    icon: ic_circle_stack,
  },
  {
    point: 'Track your progress',
    details:
      'Monitor your strengths and weaknesses with detailed analytics to improve smarter.',
    icon: ic_arrows_left_right,
  },
];
